...
types of cards in the Big Trouble in Little China set, such as Masterminds,
Schemes, Villains, Henchmen, and Heroes.
'''

from legendary.big_trouble.types import Schemes, Masterminds, Villains, Henchmen, Heroes
